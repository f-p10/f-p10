...
I recently graduated from Fanshawe College, where I completed 2 programs: Computer Programming and Analysis, Artificial Intelligence and Machine Learning. I'm interested in building real world
applications that serve a meaningful purpose.


#### I'm specifically interested in projects which solve real problems involving:
...
`Python` `Java` `C#` `JavaScript` `C++` `Kotlin` `SQL`

#### Machine Learning & AI

`PyTorch` `Scikit-Learn` `TensorFlow` `Transformers` `NLP` `Deep Learning` `LLMs` `Computer Vision`

#### Web & Backend

`React` `Angular` `FastAPI` `Express.js` `Spring Boot` `REST APIs`
...
**Tech:** Python · Pandas · Scikit-Learn · FastAPI · React

* Built preprocessing and feature engineering pipelines across multiple football datasets
* Backtested different model architectures and prediction strategies
* Developed a web application for viewing upcoming fixtures and predictions
* Added a mock betting system to track model profitability over time
* Continuously evaluates predictions against real 2026/27 season results
...
> Always building, experimenting, and trying to understand how things work under the hood.
